...
import protocols.ProtocolHIDP;
import utils.PropertiesLauncher;

/**
 * Manage an {@link Serveur_Activites}
 * @author Sh1fT
 */
public class Serveur_Activites extends JDialog {
    private ProtocolFOAMP protocolFOAMP;
    private ProtocolHIDP protocolHIDP;
    ...
    /**
     * Create a new {@link Serveur_Activites} instance
     * @param parent
     * @param modal 
     */
    public Serveur_Activites(Frame parent, boolean modal) {
        super(parent, modal);
        this.initComponents();
        this.setProtocolFOAMP(new ProtocolFOAMP(this));
        this.setProtocolHIDP(new ProtocolHIDP(this));
        ...
        this.setPropertiesLauncher(new PropertiesLauncher(
                ...
                System.getProperty("file.separator") + "Serveur_Activites.properties"));
    }

    public ProtocolFOAMP getProtocolFOAMP() {
        return protocolFOAMP;
    }

    public void setProtocolFOAMP(ProtocolFOAMP protocolFOAMP) {
        this.protocolFOAMP = protocolFOAMP;
    }

    public ProtocolHIDP getProtocolHIDP() {
        return protocolHIDP;
    }

    public void setProtocolHIDP(ProtocolHIDP protocolHIDP) {
        this.protocolHIDP = protocolHIDP;
    }
    ...
    public Integer getStatsPort() {
        return Integer.parseInt(this.getProperties().getProperty("statsPort"));
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                Serveur_Activites dialog = new Serveur_Activites(new javax.swing.JFrame(), true);
